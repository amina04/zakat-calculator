...
public class menuAr{
	...
	private void init(){
		...
		fen.setTitle("القائمة");
		pan_prin =new JPanel();
		pan_prin.setBounds(0, 0, 720, 550);
		pan_prin.setBackground(Color.white);
		pan_prin.setLayout(null);
		image=new JLabel();
		Image bg=new ImageIcon(this.getClass().getResource("/back-01.png")).getImage().getScaledInstance(720, 550,Image.SCALE_FAST);
		image.setIcon(new ImageIcon(bg));
		image.setBounds(0,0,720, 550);
		/*titre*/
		l=new JLabel("قائمة الزكاة");l.setBounds(720/2-100,10,200,40);
		l.setForeground(Color.green.darker());  
		Font police = new Font("TraditionalArabic", Font.BOLD, 28);  //On l'applique au JLabel 
		l.setFont(police); 
		/*les boutons*/
		btl=new JButton();
		Image btl1=new ImageIcon(this.getClass().getResource("/btn btl ar-01.png")).getImage(); 
		btl.setIcon(new ImageIcon(btl1));
		or_arg=new JButton();
		Image or=new ImageIcon(this.getClass().getResource("/or ar-01.png")).getImage(); 
		or_arg.setIcon(new ImageIcon(or)); 
		pr_agr=new JButton();
		Image agr=new ImageIcon(this.getClass().getResource("/agr ar-01.png")).getImage(); 
		pr_agr.setIcon(new ImageIcon(agr));
		num=new JButton();
		Image nm=new ImageIcon(this.getClass().getResource("/num ar-01.png")).getImage(); 
