...
public class Agriculture implements MouseListener {
	...
	private void init() {
		...
		String[] tab = {"Irrigation naturelle", "Irrigation artificielle"};
		...
		calc.addActionListener(new ActionListener() {
			...
			if(i==1) {
					combo.addActionListener(new ActionListener() {
					 ...
					 if(combo.getSelectedItem().equals("Irrigation naturelle"))
						{
									
									 if(val<675) {afch.setText("0");}
								     if(val>=675){double i=0; i=val*0.1; afch.setText(""+i);}
								}
					 if(combo.getSelectedItem().equals("Irrigation artificielle"))
						{
									 if(val<675) {afch.setText("0");}
